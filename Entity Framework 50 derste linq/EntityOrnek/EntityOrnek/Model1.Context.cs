...
namespace EntityOrnek
{
    ...
    public partial class DbSinavOgrenciEntities : DbContext
    {
        ...
        public virtual ObjectResult<enYuksekNotAlanOgrenciyiGetir_Result> enYuksekNotAlanOgrenciyiGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<enYuksekNotAlanOgrenciyiGetir_Result>("enYuksekNotAlanOgrenciyiGetir");
        }
    
        public virtual ObjectResult<ortalamaOgrencileriGetir_Result> ortalamaOgrencileriGetir()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ortalamaOgrencileriGetir_Result>("ortalamaOgrencileriGetir");
        }
    }
}
